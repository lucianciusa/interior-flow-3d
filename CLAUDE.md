...
- **Phase 6 (Catalog scaling & multi-room)**: pending. Tag-based catalog, glTF/Meshopt/KTX2 pipeline, Azure Blob+Front Door, HDRI+PBR, 4 room types, ~40 items, zones-as-data.

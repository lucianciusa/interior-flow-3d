            ...
            {!submitted ? (
              <>
                <DialogHeader className="mb-8">
                  <div className="flex justify-between items-start">
                    <div className="section-tag mb-6">Pro Access</div>
                  </div>
                  <DialogTitle className="text-4xl font-display tracking-tight text-[var(--ink)] leading-[1.1]">
                    Join the <em className="not-italic bg-gradient-to-r from-[var(--accent)] to-[var(--warm)] bg-clip-text text-transparent">Pro waitlist</em>
                  </DialogTitle>
                  <DialogDescription className="text-[var(--ink-2)] mt-4 text-lg leading-relaxed">
                    Be the first to unlock premium catalog items, high-res exports, and priority AI generation.
                  </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="stack-8">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="individual">Personal use / Home owner</option>
                        <option value="designer">Professional Interior Designer</option>
                  ...
                  >
                    {loading ? (
                      ...
                      <span className="flex items-center gap-2">
                        Join the waitlist <Send size={16} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                      </span>
                    )}
                  </button>
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <h3 className="text-4xl font-display tracking-tight text-[var(--ink)] mb-4 leading-tight">
                  You&apos;re officially <br />on the list.
                </h3>
                <p className="text-[var(--ink-2)] text-lg max-w-[320px] leading-relaxed mb-12">
                  We&apos;ve received your application. Keep an eye on your inbox for your exclusive invitation.
                </p>
                <button
                  onClick={handleClose}
